...
if __name__ == "__main__":
    ...
    # Auto-continue from existing Excel file (will detect row 15600 automatically)
    # Increased batch size and workers for maximum speed
    bulk_extractor.process_urls_from_csv_optimized(
        start_from=None,  # Auto-detect from existing Excel file
        has_header=False,
        batch_size=100,   # Increased batch size
        max_workers=8     # Increased thread count
    )