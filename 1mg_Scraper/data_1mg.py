...
if __name__ == "__main__":
    ...
    print("📍 Starting from row 144990 in CSV, processing next 30,000 URLs, saving to CSV.")

    csv_file = "URL.csv"
    output_csv = "bulk_drug_144990_30k.csv"
    output_excel = "bulk_drug_144990_30k.xlsx"
    ...
    # Start processing from row 144990, process next 30,000 URLs, save to CSV
